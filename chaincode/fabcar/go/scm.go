...
func (s *SmartContract) Invoke(APIstub shim.ChaincodeStubInterface) sc.Response {
	...
	} else if function == "getInvHistory" {
		return s.getInvHistory(APIstub, args)
...
func (s *SmartContract) initLedger(APIstub shim.ChaincodeStubInterface) sc.Response {
	invoices := []Invoice{
		Invoice{BilledTo: "Lenovo", InvoiceDate: "2/7/2019", InvoiceAmount: "2000", ItemDescription: "some here", GoodsReceived: "yes", IsPaid: "no", PaidAmount: "1000", Repaid: "no", RepaymentAmount: "200", Supplier: "Jes"},
	}
...
func (s *SmartContract) getInvHistory(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
